...
class AddForeignKeysToTbAtendimentoTable extends Migration {
	...
	public function up()
	{
		Schema::table('tb_atendimento', function(Blueprint $table)
		{
			...
			$table->foreign('cod_animal', 'tb_atendimento_ibfk_2')->references('cod_animal')->on('tb_animal')->onUpdate('CASCADE')->onDelete('CASCADE');
			$table->foreign('cod_funcionario', 'tb_atendimento_ibfk_3')->references('cod_funcionario')->on('tb_funcionario')->onUpdate('CASCADE')->onDelete('CASCADE');
	...
	public function down()
	{
		Schema::table('tb_atendimento', function(Blueprint $table)
		{
			...
			$table->dropForeign('tb_atendimento_ibfk_2');
			$table->dropForeign('tb_atendimento_ibfk_3');
